...
start:
	...
	cin >> h;
	if (h == 1) {
		cout << "Heuristic ? Euclidean(1), Manhattan(2), No Blocked Cells(3),"
		...
		openMap(map, letterMap, start_goal, index, mapNumber);
		findPathI(letterMap, start_goal[0][0], start_goal[0][1], start_goal[1][0], start_goal[1][1], weight, mapNumber, index, heur, 1);
